package com.medplus.cordova.plugin;
...
public class CDVDevice extends CordovaPlugin {
  ...
  public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) throws JSONException  {
      ...
      if(action.equals("download")){
          if(cordova.hasPermission(WRITE_EXTERNAL_STORAGE)){
              downloadFile(args.getJSONObject(0), callbackContext);
          }
          else {
  ...
  protected void downloadFile(JSONObject obj, CallbackContext callbackContext) throws JSONException {
  ...
  public void onRequestPermissionResult(int requestCode, String[] permissions, int[] grantResults) throws JSONException {
    ...
    switch(requestCode)
    {
        case DOWNLOAD_ACTION_PERMISSION_REQ_CODE:
            downloadFile(executeArgs.getJSONObject(0), downloadReceiverCallbackContext);
            break;
    }
  }
